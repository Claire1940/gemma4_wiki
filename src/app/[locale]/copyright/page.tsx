...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Gemma 4 Wiki',
    description: 'Copyright and intellectual property information for Gemma 4 Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Gemma 4 Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Gemma 4 Wiki',
      description: 'Copyright and intellectual property information for Gemma 4 Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Gemma 4 Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Gemma 4 Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Model Assets and Trademarks</h3>
            <p>
              Gemma 4 Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Google LLC</strong> - Owner of the Google brand and services</li>
              <li><strong>Google DeepMind</strong> - Creators of the Gemma 4 model family</li>
            </ul>
            <p>
              All model-related content, including but not limited to:
            </p>
            <ul>
              <li>Model architecture diagrams and visualizations</li>
              <li>Official documentation screenshots</li>
              <li>Model logos and branding</li>
              <li>Model names and capabilities</li>
              <li>Benchmark data and performance metrics</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>GOOGLE</strong> - Trademark of Google LLC</li>
              <li><strong>Gemma</strong> - Trademark of Google DeepMind</li>
              <li><strong>Gemma 4 Wiki</strong> - Our own branding (not affiliated with Google or Google DeepMind)</li>
            </ul>
            <p>
            ...
            <p>
              ...
              Gemma 4 Wiki<br />
              Email: <a href="mailto:dmca@gemma4.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gemma4.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Gemma 4 Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Gemma 4 Wiki (gemma4.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@gemma4.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@gemma4.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@gemma4.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gemma4.wiki</a>
            </p>
            <p>
