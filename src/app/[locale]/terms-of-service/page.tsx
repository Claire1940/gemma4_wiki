...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Gemma 4 Wiki",
    description: "Read the Terms of Service for Gemma 4 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our AI model resource platform.",
    keywords: [
      'terms of service',
      "Gemma 4 Wiki terms",
      'user agreement',
    ...
    openGraph: {
      ...
      title: "Terms of Service - Gemma 4 Wiki",
      description: "Terms and conditions for using Gemma 4 Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Gemma 4 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Gemma 4 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Gemma 4 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Gemma 4 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the "Gemma 4" open model family by Google DeepMind. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Model size and architecture guides</li>
              <li>Benchmark comparisons and performance analysis</li>
              <li>Prompting and function calling tutorials</li>
              <li>Local deployment and Ollama guides</li>
              <li>Fine-tuning and quantization walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Gemma 4 Wiki is NOT affiliated with, endorsed by, or associated with
              Google LLC or Google DeepMind. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Gemma 4 Wiki and are protected by international
              copyright, trademark, and other intellectual property laws.
            </p>

            <h3>4.2 Model Content</h3>
            <p>
              All model-related content, including but not limited to model names, documentation, logos, and
              trademarks, are the property of Google LLC and/or Google DeepMind. We use such
            ...
            <ul>
              ...
              <li><strong>Model Updates:</strong> Model availability and capabilities may change without notice. We are not responsible for model access or capability changes.</li>
            </ul>
            <p>
            ...
            <p>
              The Website may contain links to third-party websites, including GitHub, Discord, Hugging Face, social media platforms,
            ...
            <p>
              ...
              you and Gemma 4 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@gemma4.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@gemma4.wiki</a>
            </p>
            <p>
